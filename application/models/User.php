...
class User extends CI_Model
{
    ...
    public function register_user($user_data) {
        ...
        $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[8]|max_length[15]|matches[confirm_password]|md5');
    ...
    public function update_info($data) {
        ...
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata('update_error', 'Information Not Saved');
            ...
            $this->db->query($query, $values);
            $this->session->set_flashdata('update_info', 'New Information Saved');
    ...
    public function update_password($data) {
        ...
        if ($this->form_validation->run() == false) {
            $this->session->set_flashdata('password_error', 'Password Not Saved');
            ...
            $this->db->query($query, $values);
            $this->session->set_flashdata('password_updated', 'New Password Saved');
